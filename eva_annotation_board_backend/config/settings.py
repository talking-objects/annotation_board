...
if DEBUG:
    ALLOWED_HOSTS = ["*"]  # Allow all hosts in development environment
...
CUSTOM_APPS = [
    ...
    "editvideos.apps.EditvideosConfig",
    "toa_key.apps.ToaKeyConfig",
    "rangefilter",
]
...
DATABASES = {
    "default": {
        "ENGINE": (
            ...
            if not DEBUG and os.getenv("DATABASE_ENGINE") == "postgresql"
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:3001",  # Next.js development server address
    "https://board.talkingobjectsarchive.org",
    "https://eva.talkingobjectsarchive.org",
    "https://admin.talkingobjectsarchive.org",
]
